...
const content = {
  texts: {
    ...
    hero: {
      miniTag: "AGÊNCIA DE TRÁFEGO PAGO PARA ADVOGADOS",
      title: (
        <h1>
          Advogado, receba{" "}
      ...
      subtitle: (
        <p>
          Especialistas no <span className="font-bold">Marketing Jurídico</span>
          , somos uma Agência que ajuda diariamente{" "}
          <span className="font-bold text-primaryLight">
            advogados que querem aumentar seu faturamento
          </span>{" "}
